<template>
    <div class="btn-group m_pagination" role="group" aria-label="Pagination">

        <button type="button"
                :class="['btn','btnPrev','btn-'+secondaryVariant,btnSize]"
        ...
        -->
        <button type="button"
                :class="['btn','btnNext','btn-'+secondaryVariant,btnSize]"
